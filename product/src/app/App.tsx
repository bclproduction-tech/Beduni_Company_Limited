...
export default function App() {
  ...
  const screenshots = [
    {
      image: 'https://images.unsplash.com/photo-1762326866764-1ef1a008e0ad?w=1200',
      title: 'Interactive Problem Solving',
    },
    {
      image: 'https://images.unsplash.com/photo-1758685734312-5134968399a8?w=1200',
      title: 'Step-by-Step Solutions',
    },
    {
      image: 'https://images.unsplash.com/photo-1761044592252-cc6c1f3bf210?w=1200',
  ...
  const faqs = [
    ...
    {
      question: 'How can I get Hesabu Safi?',
      answer:
        'Hesabu Safi is available for purchase through BCL (our parent company). Please visit our BCL website or contact us directly for licensing information and installation support.',
    },
  ];
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          >
            Premium mathematics software designed for the African education system. Built
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-[#8B1538] to-[#C1164A] text-white rounded-full font-semibold hover:shadow-2xl hover:shadow-maroon-500/50 transition-all duration-300 flex items-center gap-2 group"
            >
              Learn More
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-[#4a90e2] to-[#6ba3e8] text-white rounded-full font-semibold hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 flex items-center gap-2"
            >
          ...
          >
            ...
            >
              <div className="text-4xl font-bold bg-gradient-to-r from-[#8B1538] to-[#C1164A] bg-clip-text text-transparent">
                100%
              </div>
              <div className="text-sm text-gray-400 mt-2">Offline Access</div>
            </motion.div>
            <motion.div
              className="text-center"
              whileHover={{ scale: 1.1 }}
              transition={{ type: 'spring', stiffness: 300 }}
            >
              <div className="text-4xl font-bold bg-gradient-to-r from-[#4a90e2] to-[#6ba3e8] bg-clip-text text-transparent">
                CBC
              </div>
            ...
            <motion.div
              ...
              transition={{ type: 'spring', stiffness: 300 }}
            >
              <div className="text-4xl font-bold bg-gradient-to-r from-[#E8E8E8] to-[#D3D3D3] bg-clip-text text-transparent">
                0
              </div>
              <div className="text-sm text-gray-400 mt-2">Data Tracking</div>
            </motion.div>
          </motion.div>
        </motion.div>
      ...
      <section className="relative py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <StatCard number="50" suffix="+" label="Schools Using" delay={0} />
            <StatCard number="5000" suffix="+" label="Active Students" delay={0.1} />
            <StatCard number="200" suffix="+" label="Teachers Empowered" delay={0.2} />
            <StatCard number="95" suffix="%" label="Satisfaction Rate" delay={0.3} />
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Designed specifically for the African education landscape with unique features
            </p>
          </motion.div>
      ...
      <section id="testimonials" className="relative py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-400 text-lg">
              Trusted by teachers and students across Africa
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 bg-gradient-to-r from-[#8B1538] to-[#C1164A] text-white rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-maroon-500/50 transition-all duration-300"
              >
                Download Hesabu Safi
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 bg-white/10 backdrop-blur-lg border border-white/30 text-white rounded-full font-semibold text-lg hover:bg-white/20 transition-all duration-300"
              >
                Learn More
              </motion.button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-[#8B1538] to-[#C1164A] rounded-full flex items-center justify-center">
              ...
              <p className="text-gray-400 max-w-md mb-6">
                Premium mathematics software designed for the African education system.
