...
>
  ...
  <img
    src={logo}
    alt="Beduni Company Limited Logo"
    className="h-7 w-auto object-contain"
  />

  {/* Brand Text */}
  <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-gold-400 dark:to-yellow-500 bg-clip-text text-transparent">
    BCL
  </span>
</motion.div>
