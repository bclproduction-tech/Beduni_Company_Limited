...
import learning from '../../assets/img.png';
          ...
          >
            <div className="backdrop-blur-xl bg-white/70 dark:bg-white/5 rounded-2xl border border-gray-200/50 dark:border-white/10 p-8 shadow-xl">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                We envision a future where every student in Kenya has access to world-class mathematics education powered by intelligent software that adapts to their unique learning journey.
              </p>
            </div>
            ...
            <div className="backdrop-blur-xl bg-white/70 dark:bg-white/5 rounded-2xl border border-gray-200/50 dark:border-white/10 p-8 shadow-xl">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                Long-Term Kenyan Impact
              </h3>
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                Our commitment extends beyond software we're building a foundation for Kenya's digital future, one student at a time.
              </p>
            </div>
          </motion.div>
